// forked from: https://github.com/klendi/react-top-loading-bar/blob/master/src/index.tsx

import * as React from 'react'
import { CSSProperties, useEffect, useState, forwardRef, useImperativeHandle, useRef } from 'react'
